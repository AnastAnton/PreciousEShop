...
public class Login extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)     //sto url den emfanizei tipota pera apo to preciousEshop ara 
            throws ServletException, IOException {
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            if (username.equalsIgnoreCase("admin") && password.equals("admin")) {           //equalsIgnoreCase ignores kefalia mikra ta dexete ola
